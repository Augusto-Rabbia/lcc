...
//elegir_palabras_crear_archivo: FILE, FILE, Int, Int, Int -> void
//Crea, a partir de todos los datos dados por el usuario, un archivo llamado Caracteristicas.txt con los datos necesarios
//para la creacion de la sopa. Se seleccionan aleatoriamente las palabras del archivo de ingreso y se escriben en el archivo de output.
...
void elegir_palabras_crear_archivo(FILE *archivoLeer, FILE *archivoEscribir, int cantPalabras, int dimension, int complejidad) {
    int contador = 0, elegir, posReemplazada, palabrasHalladas = 0;
    char buffer[255], palabras[cantPalabras][255];
...
int main() {
    ...
    elegir_palabras_crear_archivo(pArchivoaLeer, pArchivoaEscribir, cantPalabras, dimension, complejidad);
