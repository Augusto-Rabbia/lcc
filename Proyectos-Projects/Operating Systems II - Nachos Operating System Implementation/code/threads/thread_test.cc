...
static const Test TESTS[] = {
    ...
    { &ThreadTestChannelSimple, "channel simple", "Simple message passing between the master thread and a child thread" },
    { &ThreadTestChannelMultiple, "channel multiple", "Message passing between multiple sender and receiver threads" },
    { &ThreadTestJoin, "join simple", "Simple test for Join method" }
};
