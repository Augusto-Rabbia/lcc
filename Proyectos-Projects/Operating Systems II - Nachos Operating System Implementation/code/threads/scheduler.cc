...
void
Scheduler::Reeschedule(Thread* toBeReescheduled, unsigned newPriority)
{
    readyList[toBeReescheduled->GetPriority()].Remove(toBeReescheduled);
    readyList[newPriority].Append(toBeReescheduled);
}
